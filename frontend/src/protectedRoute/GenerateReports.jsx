  ...
  return (
    <>
      <button
        ...
        className="bg-[#2B282B] flex border border-gray-300 items-center justify-center gap-2 font-semibold text-white px-6 py-2 rounded-sm transition cursor-pointer text-sm tracking-wider whitespace-nowrap"
